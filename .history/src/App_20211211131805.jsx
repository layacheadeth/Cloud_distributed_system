...
const AddSong= ({onUpload })=>{
  ...
  return (
    <div className="newSong">
      ...
      onChange={e=> setSongData({...songData,title:e.target.value || false})} />

      <TextField label="artist" 
      value={songData.owner} 
      onChange={e=> setSongData({...songData,owner:e.target.value || false})} 
      />

      <TextField label="description" 
      value={songData.description} 
      onChange={e=> setSongData({...songData,description:e.target.value || false})}
      />


      <input type="file" accept="audio/mp3" onChange={e => setMp3Data(e.target.files[0] || false)} />
